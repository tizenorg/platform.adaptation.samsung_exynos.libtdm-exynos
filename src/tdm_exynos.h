...
tdm_error    exynos_output_set_mode(tdm_output *output, tdm_output_mode *mode);
...
tdm_error    exynos_layer_set_buffer(tdm_layer *layer, tdm_buffer *buffer);
...
typedef struct _tdm_exynos_data
{
    tdm_display *dpy;
